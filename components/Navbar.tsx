    ...
    >
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
        ...
        <div className="hidden md:flex space-x-6 text-lg font-medium">
          ...
          <Link href="/booking" className="hover:text-[#00aaff] transition">
            Đặt trước
          </Link>
          <Link href="/contact" className="hover:text-[#00aaff] transition">
            Liên hệ
          </Link>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    {/* Biểu tượng ellipsis */}
                    <span className="ml-auto md:block hidden size-4 text-gray-500">⋮</span>
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent
                ...
                >
                  ...
                  <DropdownMenuItem onClick={() => router.push("/historybooking")}>
                    ...
                    <span className="ml-2">Lịch sử đặt chỗ</span>
                  </DropdownMenuItem>
                  
                  {user.role === "admin" && (
                    <DropdownMenuItem onClick={() => router.push("/admin")}>
                      <MdOutlineAdminPanelSettings size={16} />
                      <span className="ml-2">Trang quản trị</span>
                    </DropdownMenuItem>
                  )}
                </DropdownMenuContent>
              </DropdownMenu>
